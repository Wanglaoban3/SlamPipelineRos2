...
// ROS2 port of pose_estimator.hpp (ros::Time -> rclcpp::Time)
...
private:
  rclcpp::Time init_stamp{0, 0, RCL_ROS_TIME};             // when the estimator was initialized
  rclcpp::Time prev_stamp{0, 0, RCL_ROS_TIME};             // when the estimator was updated last time
  rclcpp::Time last_correction_stamp{0, 0, RCL_ROS_TIME};  // when the estimator performed the correction step
