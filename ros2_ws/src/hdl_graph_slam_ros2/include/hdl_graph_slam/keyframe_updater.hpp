...
// ROS2 port of keyframe_updater.hpp (ros::NodeHandle -> ParamNodeHandle)
...
public:
   ...
   * @param pnh
   */
  KeyframeUpdater(ParamNodeHandle& pnh) : is_first(true), prev_keypose(Eigen::Isometry3d::Identity()) {
